 ...
 * - 하나의 URI는 하나의 고유한 리소스(Resource)를 대표하도록 설계하는 전송방식임
 ...
 * 
 * @RestController 
 * - Controller가 REST 방식을 처리하기 위한 것임을 명시한것
 * - 메서드의 리턴 타입으로 사용자가 정의한 클래스 타입도 사용할 수 있고, 이 외에도 여러 타입으로 보내는데 이를 JSON이나 XML로 자동 처리를 한다.
 * 
 *  
...
public class SimpleController {
	...
	public Person sayGreet() {
		...
		Person p = new Person("이지훈", "기타히어로가 되고싶다..");
		return p;
	}
	@GetMapping("/allGreet")
